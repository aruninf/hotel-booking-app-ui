...
import 'package:nudge/features/home/presentation/screens/widgets/checkedIn_event_screen.dart';
      ...
      child: Scaffold(
        body: Stack(
          children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                SvgPicture.asset(
                                  Assets.images.eventCalendar.path,
                                ),
            ...
            Positioned(
              bottom: context.devicePaddingBottom + 20,
              left: 52,
              right: 52,
              child: AppOutlinedButtonWithArrow(
                ...
                onPressed: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => CheckedInEventScreen(),
                    ),
                  );
                },
              ),
