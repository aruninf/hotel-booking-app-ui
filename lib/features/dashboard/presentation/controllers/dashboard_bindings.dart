...
import 'package:nudge/features/dashboard/presentation/controllers/dashboard_controller.dart';
...
class DashboardBindings extends Bindings {
  ...
  void dependencies() {
    Get
      ...
      ..put(
        DashboardController(remoteSource: Get.find<DashboardRemoteSource>()),
      );
  }
}
