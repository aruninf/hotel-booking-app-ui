...
import 'package:nudge/features/{{name}}/data/source/{{name.snakeCase()}}_remote_source.dart';
import 'package:nudge/features/{{name}}/presentation/controllers/{{name.snakeCase()}}_controller.dart';
